...
class ClassStatistics:
    ...
    def _create_layout(self) -> html.Div:
        ...
        ...    dcc.Dropdown(id='class-dropdown-class-stats', options=[...]),
        ...    html.Div(id='page-content-class-stats')
        ... ])
        """
        return html.Div(
            children=[
                # Creates a Location component to get the current URL
                dcc.Location(id='url-class-stats', refresh=False),
                # Creates a container for the page content
                dbc.Container(id='page-content-class-stats', fluid=True),
                # Creates a Store component to store the current page
                dcc.Store(id='current-page-class-stats', data=self.keys[0]),
    ...
    def _register_callbacks(self, app: Dash) -> None:
        ...
        app.callback(
            Output(
                component_id='page-content-class-stats',
                component_property='children',
            ),
            Input(
                component_id='current-page-class-stats',
                component_property='data',
            ),
            Input(
                component_id='page-dropdown-class-stats',
        ...
        app.callback(
            ...
            Input(
                component_id='prev-page-class-stats',
                component_property='n_clicks',
            ),
            Input(
                component_id='next-page-class-stats',
                component_property='n_clicks',
            ),
            Input(
                component_id='page-dropdown-class-stats',
